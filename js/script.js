  ...
  if (groupsContainer) {
    ...
    const groups = [
      ...
      },
      {
        ...
        members: 875,
        image: "https://source.unsplash.com/random/800x600/?vegan-food",
      },
      {
        id: 3,
        name: "HIIT Warriors",
        ...
        members: 1540,
        image: "https://source.unsplash.com/random/800x600/?hiit-workout",
      },
      {
        id: 4,
    ...
    groups.forEach((group) => {
      ...
      col.innerHTML = `
                <div class="card group-card">
                    <img src="${
                      group.image
                    }" class="card-img-top group-card-img" alt="${group.name}">
                    <div class="card-body">
